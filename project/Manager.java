...
public class Manager {
    ...
    public static void numTransactions(Connection con, int lower, int upper) {
        try {
            ...
            ResultSet rs = selectStmt.executeQuery("SELECT s.sID, s.sName, s.sExperience, COUNT(t.tID) as numT FROM salesperson s LEFT JOIN transaction t ON s.sID = t.sID WHERE sExperience >= " + l + " AND sExperience <= " + u + " GROUP BY s.sID");
